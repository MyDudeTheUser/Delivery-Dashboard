...
Alert rules determine *when* a notification should be sent based on specific error criteria. 
...
6. *(Optional)* Add tags like `environment` and `release` to the Slack message for better context.
